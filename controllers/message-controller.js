...
const { questions, status } = require('../utils/msgtemplates')

module.exports = {
    outputQuestions: async function (record, client, replyToken) {
        try {
            // repeat questions
            ...
            if (questionIndex < questions.length) {
                ...
                // } else {
                //     await record.answer.text.push(event.message.text)
                //     record.questionIndex += 1
                //     await record.save()
                // }
